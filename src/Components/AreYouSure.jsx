...
const AreYouSure = ({ setAreYou, AreYou }) => {
    return (
        <div>
                ...
                <div className="relative p-4 w-full max-w-md max-h-full">
                    <div className="relative bg-white rounded-lg shadow ">
                        ...
                        <div className="p-4 md:p-5 text-center">
                            ...
                            <button onClick={() => setAreYou({ ...AreYou, confirm: true, one: false })} data-modal-hide="popup-modal" type="button" className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300  font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                                Yes, I'm sure
                            </button>
